#! /bin/bash
HOME_DIR="/usr/local/google/home/jperrott/test"
TARGETS=(
  '5.0.x'
  '5.1.x'
  '5.2.x'
...
# Remove material2 repo
#sudo rm -r "$HOME_DIR/material2";
# Fresh clone of the repo
git clone https://github.com/angular/material2 &>/dev/null;
echo 'Cloned Material2 repo';
