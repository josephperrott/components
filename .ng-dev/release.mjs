...
export const release = {
  ...
  prereleaseCheck: async (newVersionStr, builtPackagesWithInfo) => {
    ...
    const assertValidUpdateMigrationCollections = await import ('../tools/release-checks/check-migration-collections.mjs');
    const assertValidNpmPackageOutput = await import ('../tools/release-checks/npm-package-output/index.mjs');
